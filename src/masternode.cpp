...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDos)
{
    ...
    // should be at least not earlier than block when 1000 VIOG tx got nMasternodeMinimumConfirmations
    ...
    GetTransaction(vin.prevout.hash, tx2, Params().GetConsensus(), hashBlock, true);
    {
        ...
        {
            CBlockIndex* pMNIndex = (*mi).second; // block for 1000 VIOG tx -> 1 confirmation
